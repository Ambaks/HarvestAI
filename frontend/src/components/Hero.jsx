        ...
        <div className="container relative" ref={parallaxRef}>
            ...
            mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]">
                <h1 className="h1 mb-6">
                    The Essential Link Between Local Farmers and Exporters
                </h1>
                ...
                text-n-2 lg:mb-8">
                    Empowering local farmers and enabling exporters to streamline operations through instant payments, cutting-edge AI, real-time monitoring, and actionable data insights.                      </p>
                <Button className="md:mt-5" href="/login" white>
                    Get started
                </Button>
            </div>
                ...
                bg-conic-gradient">
                    <div className="relative bg-n-8 rounded-[1rem]">
                        ...
                        overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                            <img 
                            src={robot}
                            className="w-full scale-[1.7rem] translate-y-[8%]
