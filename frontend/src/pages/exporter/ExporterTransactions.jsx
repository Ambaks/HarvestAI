...
const ExporterTransactions = () => {
  ...
  return (
    <Container sx={{ display: "flex", justifyContent: "space-between", mt: 4 }}>
      ...
      <Box sx={{ width: "33%" }}>
        <Card sx={{ boxShadow: 3, borderRadius: 3, height: "420px", display: "flex", flexDirection: "column", bgcolor: "#ffffff" }}>
          <CardHeader title="Incoming Applications" sx={{ textAlign: "center", bgcolor: "#f5f5f5", py: 2, fontWeight: "bold", display: "flex", alignItems: "center", justifyContent: "center" }} />
          <CardContent sx={{ overflowY: "auto", flexGrow: 1 }}>
            {orders.length > 0 ? (
...
export default ExporterTransactions;